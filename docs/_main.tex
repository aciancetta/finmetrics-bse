...
\begin{center}\includegraphics[width=2.4\linewidth]{pic_finmetrics} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# We can study when adjustment really matters using the results of the previous Monte Carlo simulation}
