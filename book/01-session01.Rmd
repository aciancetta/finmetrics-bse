...
# plot
plot.ts(y, main = "Non-stationary series (a pretty funny one)")
```
...
hist(x_means*sqrt(t_max), breaks = 20, freq = FALSE, 
     ...
     xlab = "Simulated means (rescaled by sqrt(T))")
...
```{r message=FALSE, warning=FALSE}
# We can study when adjustment really matters using the results of the previous Monte Carlo simulation
