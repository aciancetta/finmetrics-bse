...
\date{Last update: January 16, 2025}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# to add solutions}
\CommentTok{\# library(pdftools)}
\CommentTok{\# }
\CommentTok{\# pdfs \textless{}{-} c("docs/\_main.pdf",}
\CommentTok{\#   paste0("../session0", 4:9, "{-}exercises.pdf"),}
\CommentTok{\#   "../session10{-}exercises.pdf")}
\CommentTok{\# }
\CommentTok{\# pdf\_combine(pdfs, }
\CommentTok{\#             output = "docs/\_main\_solutions.pdf")}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\DocumentationTok{\#\# likelihood}
\NormalTok{arma11tgarch11\_objective }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(y, params) \{}
  \CommentTok{\#initializations}
\NormalTok{  c      }\OtherTok{\textless{}{-}}\NormalTok{ params[}\DecValTok{1}\NormalTok{]}
\NormalTok{  phi    }\OtherTok{\textless{}{-}}\NormalTok{ params[}\DecValTok{2}\NormalTok{]}
\NormalTok{  theta  }\OtherTok{\textless{}{-}}\NormalTok{ params[}\DecValTok{3}\NormalTok{]}
...
\NormalTok{  gamma  }\OtherTok{\textless{}{-}}\NormalTok{ params[}\DecValTok{7}\NormalTok{]}
\NormalTok{  t\_max  }\OtherTok{\textless{}{-}} \FunctionTok{length}\NormalTok{(y)}
\NormalTok{  res\_filter }\OtherTok{\textless{}{-}} \FunctionTok{arma11tgarch11\_filter}\NormalTok{(y, params)}
\NormalTok{  sig2 }\OtherTok{\textless{}{-}}\NormalTok{ res\_filter}\SpecialCharTok{$}\NormalTok{sig2}
\NormalTok{  eps }\OtherTok{\textless{}{-}}\NormalTok{ res\_filter}\SpecialCharTok{$}\NormalTok{eps}
  
  \CommentTok{\# if{-}else statement calculating negative loglik}
  \CommentTok{\# if (all(is.finite(params)) \& omega\textgreater{}=0 \& alpha\textgreater{}0 \& beta\textgreater{}0 \& gamma\textgreater{}0 \& (alpha+beta+gamma/2)\textless{}1) \{}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{all}\NormalTok{(}\FunctionTok{is.finite}\NormalTok{(params)) }\SpecialCharTok{\&}\NormalTok{ (alpha}\SpecialCharTok{+}\NormalTok{beta}\SpecialCharTok{+}\NormalTok{gamma}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)}\SpecialCharTok{\textless{}}\DecValTok{1}\NormalTok{) \{}
\NormalTok{    neg\_loglik }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\NormalTok{res\_filter}\SpecialCharTok{$}\NormalTok{loglik}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{    neg\_loglik }\OtherTok{\textless{}{-}} \ConstantTok{Inf}
\NormalTok{  \}}
  \FunctionTok{return}\NormalTok{(neg\_loglik)}
...
\begin{Highlighting}[]
\DocumentationTok{\#\# MLE}
\NormalTok{arma11tgarch11\_mle }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(y, params) \{}
  \CommentTok{\# nlminb function optimizing parameters }
\NormalTok{  fit }\OtherTok{\textless{}{-}} \FunctionTok{nlminb}\NormalTok{(}\AttributeTok{start =}\NormalTok{ params, }\AttributeTok{objective =}\NormalTok{ arma11tgarch11\_objective, }
                \AttributeTok{y =}\NormalTok{ y, }
                \AttributeTok{lower =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{, }\SpecialCharTok{{-}}\FloatTok{0.999}\NormalTok{, }\SpecialCharTok{{-}}\FloatTok{0.999}\NormalTok{, }\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{, }\FloatTok{0.01}\NormalTok{, }\FloatTok{0.01}\NormalTok{, }\FloatTok{0.001}\NormalTok{), }
                \AttributeTok{upper =} \FunctionTok{c}\NormalTok{( }\DecValTok{1}\NormalTok{,  }\FloatTok{0.999}\NormalTok{,  }\FloatTok{0.999}\NormalTok{,  }\DecValTok{1}\NormalTok{, }\FloatTok{0.9}\NormalTok{, }\FloatTok{0.9}\NormalTok{, }\FloatTok{0.9}\NormalTok{))}

  \DocumentationTok{\#\# output}
  \FunctionTok{names}\NormalTok{(fit}\SpecialCharTok{$}\NormalTok{par) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"c"}\NormalTok{, }\StringTok{"phi"}\NormalTok{, }\StringTok{"theta"}\NormalTok{, }\StringTok{"omega"}\NormalTok{, }\StringTok{"alpha"}\NormalTok{, }\StringTok{"beta"}\NormalTok{, }\StringTok{"gamma"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{startparams }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.9}\NormalTok{, }\DecValTok{0}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.8}\NormalTok{, }\FloatTok{0.01}\NormalTok{)}
\NormalTok{mle }\OtherTok{\textless{}{-}} \FunctionTok{arma11tgarch11\_mle}\NormalTok{(y, startparams)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(}\AttributeTok{MLE =}\NormalTok{ mle, }
             \AttributeTok{true =} \FunctionTok{c}\NormalTok{(c, phi, theta, omega, alpha, beta, gamma))}
\FunctionTok{row.names}\NormalTok{(tab) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"c"}\NormalTok{, }\StringTok{"phi"}\NormalTok{, }\StringTok{"theta"}\NormalTok{, }\StringTok{"omega"}\NormalTok{, }\StringTok{"alpha"}\NormalTok{, }\StringTok{"beta"}\NormalTok{, }\StringTok{"gamma"}\NormalTok{)}
...
\NormalTok{sp500 }\OtherTok{\textless{}{-}} \FunctionTok{ts}\NormalTok{(sp500}\SpecialCharTok{$}\NormalTok{adjusted\_close[}\FunctionTok{nrow}\NormalTok{(sp500)}\SpecialCharTok{:}\DecValTok{1}\NormalTok{], }\AttributeTok{start =} \FunctionTok{c}\NormalTok{(}\DecValTok{1999}\NormalTok{, }\DecValTok{11}\NormalTok{, }\DecValTok{1}\NormalTok{), }\AttributeTok{freq =} \DecValTok{365}\NormalTok{)}
\NormalTok{d }\OtherTok{\textless{}{-}} \FunctionTok{diff}\NormalTok{(}\FunctionTok{log}\NormalTok{(sp500))}\SpecialCharTok{*}\DecValTok{252}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# plot fitted values}
\NormalTok{filter\_sp500 }\OtherTok{\textless{}{-}} \FunctionTok{arma11tgarch11\_filter}\NormalTok{(d, mle\_sp500)}
\NormalTok{eps  }\OtherTok{\textless{}{-}}\NormalTok{ filter\_sp500}\SpecialCharTok{$}\NormalTok{eps}
\NormalTok{sig2 }\OtherTok{\textless{}{-}}\NormalTok{ filter\_sp500}\SpecialCharTok{$}\NormalTok{sig2}
\NormalTok{z    }\OtherTok{\textless{}{-}}\NormalTok{ filter\_sp500}\SpecialCharTok{$}\NormalTok{z}

\NormalTok{c      }\OtherTok{\textless{}{-}}\NormalTok{ mle\_sp500[}\DecValTok{1}\NormalTok{]}
\NormalTok{phi    }\OtherTok{\textless{}{-}}\NormalTok{ mle\_sp500[}\DecValTok{2}\NormalTok{]}
\NormalTok{theta  }\OtherTok{\textless{}{-}}\NormalTok{ mle\_sp500[}\DecValTok{3}\NormalTok{]}
\NormalTok{omega  }\OtherTok{\textless{}{-}}\NormalTok{ mle\_sp500[}\DecValTok{4}\NormalTok{]}
\NormalTok{alpha  }\OtherTok{\textless{}{-}}\NormalTok{ mle\_sp500[}\DecValTok{5}\NormalTok{]}
\NormalTok{beta   }\OtherTok{\textless{}{-}}\NormalTok{ mle\_sp500[}\DecValTok{6}\NormalTok{]}
\NormalTok{gamma  }\OtherTok{\textless{}{-}}\NormalTok{ mle\_sp500[}\DecValTok{7}\NormalTok{]}
\NormalTok{t\_max  }\OtherTok{\textless{}{-}} \FunctionTok{length}\NormalTok{(d)}

\NormalTok{fitted\_sp500 }\OtherTok{\textless{}{-}}\NormalTok{ c }\SpecialCharTok{+}\NormalTok{ phi}\SpecialCharTok{*}\NormalTok{d }\SpecialCharTok{+}\NormalTok{ theta}\SpecialCharTok{*}\NormalTok{eps}
\NormalTok{upper\_sp500     }\OtherTok{\textless{}{-}}\NormalTok{ fitted\_sp500 }\SpecialCharTok{+} \FloatTok{1.96}\SpecialCharTok{*}\FunctionTok{sqrt}\NormalTok{(sig2)}
\NormalTok{lower\_sp500     }\OtherTok{\textless{}{-}}\NormalTok{ fitted\_sp500 }\SpecialCharTok{{-}} \FloatTok{1.96}\SpecialCharTok{*}\FunctionTok{sqrt}\NormalTok{(sig2)}
\end{Highlighting}
\end{Shaded}
